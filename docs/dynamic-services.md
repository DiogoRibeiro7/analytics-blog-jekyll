...
This contract is the transport. [Correction reports](components.md#correction-reports) (#256) and the [contact form](components.md#contact-form) (#261) define what they send and show; comments (#253), subscriptions (#254), reactions (#255), moderation (#257) and Webmentions (#258) would do the same, each with its own paths, payloads and error codes, and none with its own client.
