...
- The starter template's deploy workflow set up Ruby 3.1, which cannot install the gem since 0.8.0 requires Ruby 3.2, and the installation guide said Ruby 3.0 was enough. Both say 3.2 now. `datalog check` also accepted Ruby 3.0; it now checks the requirement the gemspec declares (#242).
